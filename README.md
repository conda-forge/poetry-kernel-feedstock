...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/poetry-kernel-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14890&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/poetry-kernel-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `poetry-kernel` can be installed with:

```
conda install poetry-kernel
```

It is possible to list all of the versions of `poetry-kernel` available on your platform with:
